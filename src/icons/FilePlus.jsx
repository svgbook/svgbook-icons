...
renderPath['outline'] = (color) => (
  <Fragment>
    ...
    <line x1='10' y1='13.34' x2='14' y2='13.34' />
  </Fragment>
)
...
renderPath['fill'] = () => (
  <Fragment>
    <path
      stroke='none'
      d='M17,9,17,8.92l-3.2-3.2-.06-.07h0a.65.65,0,0,0-.15-.1.39.39,0,0,0-.18,0H8.67A1.84,1.84,0,0,0,6.83,7.33v9.34A1.84,1.84,0,0,0,8.67,18.5h6.66a1.84,1.84,0,0,0,1.84-1.83V9.34A.53.53,0,0,0,17,9Zm-3,4.85H12.5v1.5a.5.5,0,0,1-1,0v-1.5H10a.5.5,0,0,1-.5-.5.5.5,0,0,1,.5-.5h1.5v-1.5a.5.5,0,1,1,1,0v1.5H14a.5.5,0,0,1,.5.5A.5.5,0,0,1,14,13.83Zm0-5a.17.17,0,0,1-.17-.16V7.21l1.63,1.62Z'
    />
  </Fragment>
)
...
const FilePlus = forwardRef((props, ref) => {
